	...
	return (
		<div className="mt-5 mb-10 h-full flex flex-col items-center">
			...
			<div className="text-center mb-10">
				<h1 className="text-3xl font-bold text-gray-600">Study with Quizzes</h1>
				<p className="mt-2 text-xl font-semibold text-gray-500">
					Choose the correct answer to the question below.
				</p>
			</div>
			<div className="relative w-2/3 h-44 py-10 flex flex-col items-center gap-4 bg-white border-2 rounded-2xl">
				{correctAnswer && (
			...
			<div className="my-10 grid grid-cols-2 gap-4 w-2/3">
