...
const Quote: React.FC = () => {
	...
	return (
		<div className="relative flex items-center justify-center bg-gray-100 p-10 max-sm:p-2">
			<button
				onClick={handlePrev}
				className="absolute left-5 p-4 text-gray-300 rounded-full hover:text-gray-500 max-sm:-left-5"
			>
				<FontAwesomeIcon icon={faChevronLeft} className="w-10 h-10" />
			</button>
			<div className="  bg-white px-10 pt-10 pb-5 rounded-lg shadow-lg w-full text-center">
			...
			<button
				onClick={handleNext}
				className="absolute right-5 p-4 text-gray-300 rounded-full hover:text-gray-500 max-sm:-right-5"
			>
